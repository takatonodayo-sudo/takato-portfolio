...
const modalData = {
  ...
  side: {
    title: "副業広告運用コンサル",
    lead: "副業で広告運用コンサルに取り組みたい方向けに、案件獲得からMeta広告の出稿、運用手順の理解までを1か月でサポートします。物販・アパレルの継続支援にも対応します。",
    points: ["内容: Meta広告の出稿準備、運用手順、改善の見方を整理", "サポート: 案件獲得から初回出稿まで、MTGとチャットで対応", "料金: 広告運用コンサルは1か月30,000円。物販・アパレルは月額5,000円"]
  }
};
